...
kombu.transport.SQS
===================
aliyun SQS transport module for Kombu. This package implements an AMQP-like
interface on top of aliyuns SQS service, with the goal of being optimized for
...
SQS Features supported by this transport:
  Long Polling:
    http://docs.aws.aliyun.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/
      sqs-long-polling.html
    Long polling is enabled by setting the `wait_time_seconds` transport
    option to a number > 1. aliyun supports up to 20 seconds. This is
